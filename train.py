...
if __name__ == "__main__":
    ...
    # Generate and save mapping of geocell labels so they are contiguous in training.
    ...
    # AdamW optimizer, learning rate 0.0001, weight decay 0.001
    ...
    for epoch in range(EPOCHS):
        ...
        for images, geocells_smoothed, latlon_of_image, geocell_index in train_progress:
            ...
            # The quadtree index mapped to continous label
